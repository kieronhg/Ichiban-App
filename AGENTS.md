## Codex Design Handoff — Flutter Implementation Guide

### How to handle incoming designs
When given a Codex Design handoff bundle, screenshot, or design specification:
...
When Codex Design describes web concepts, translate them as follows:
